      ...
      apply: (src) =>
        replaceOnce(
          ...
          [
            ...
            '          createBaseVNode("div", {',
            '            class: "pointer",',
            '            title: "Resize window to the KVM resolution (1:1)",',
            '            style: { flex: "0 0 auto", padding: "0 10px", height: "100%", display: "flex", alignItems: "center", fontSize: "12px", fontWeight: "600", opacity: "0.75", userSelect: "none", WebkitAppRegion: "no-drag" },',
            "            onClick: () => window.utils.glFitWindow()",
            '          }, "1:1"),',
            "",
          ].join("\n"),
